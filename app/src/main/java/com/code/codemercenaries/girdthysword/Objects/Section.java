...
public class Section {
    ...
    public Section(String _id, String _book_name, int _chapter_num, int _start_verse_num, int _end_verse_num, String _version) {
    ...
    public Section(String _book_name, int _chapter_num, int _start_verse_num, int _end_verse_num, String _version) {
        this._book_name = _book_name;
        this._chapter_num = _chapter_num;
        this._start_verse_num = _start_verse_num;
        this._end_verse_num = _end_verse_num;
    ...
    public void set_chapter_num(int _chapter_num) {
        this._chapter_num = _chapter_num;
    }
    ...
    public String toString() {
        String string = this.get_book_name() + " " + this.get_chapter_num() + ":" + this.get_start_verse_num() + "-" + this.get_end_verse_num();
        return string;
    }
}
