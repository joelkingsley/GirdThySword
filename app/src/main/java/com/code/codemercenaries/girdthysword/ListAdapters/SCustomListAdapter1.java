...
public class SCustomListAdapter1 extends ArrayAdapter<String> {
    ...
    public void setTheme(final View v) {
        final String themes[] = new String[]{"light_grey"};
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
    ...
    public void setFont(final View v) {
        final String fonts[] = new String[]{
                context.getString(R.string.notosans_eng_black_font_name),
                context.getString(R.string.notosans_eng_light_font_name)
        };
